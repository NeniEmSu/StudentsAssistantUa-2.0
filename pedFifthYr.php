...
<head>
    ...
    <title>Pediatrics OSCE 5th Year | Students Assistant UA</title>
            ...
            <div class="landing" style="width: 100%">
                ...
                <p>Click to go to Specific section:
                    <ul>
                        ...
                        <ol>
                            <li><a href="#first-pdf">Pdf from module</a></li>
                            <li><a href="#second-pdf">Pdf from Intranet</a></li>
                        </ol>
                ...
                <h4 id="first-pdf" class="offset">Material provided from TSMU Module site</h4>
                <object data="oski/oski-5/Алгоритми  5 курс - педіатрія-2019.pdf#toolbar=0" type="application/pdf"
                    width="100%" height="500px" style="margin-top:2rem; margin-bottom:2rem; border: none;">
                    <iframe src="oski/oski-5/Алгоритми  5 курс - педіатрія-2019.pdf#toolbar=0" width="100%"
                        height="500px" style="margin-top:2rem; margin-bottom:2rem; border: none;">
                        This browser does not support PDFs. Please download the PDF to view it:
                        <a href="oski/oski-5/Алгоритми  5 курс - педіатрія-2019.pdf">Download PDF</a>
                    </iframe>
                </object>

                <h4 id="second-pdf" class="offset">Material provided from TSMU Intranet site</h4>
                <object data="oski/oski-5/OSCE-5th-course-pediatrics.pdf#toolbar=0" type="application/pdf" width="100%"
                    height="500px" style="margin-top:2rem; margin-bottom:2rem; border: none;">
                    <iframe src="oski/oski-5/OSCE-5th-course-pediatrics.pdf#toolbar=0" width="100%" height="500px"
                        style="margin-top:2rem; margin-bottom:2rem; border: none;">
                        This browser does not support PDFs. Please download the PDF to view it:
                        <a href="oski/oski-5/OSCE-5th-course-pediatrics.pdf">Download PDF</a>
                    </iframe>
                </object>
