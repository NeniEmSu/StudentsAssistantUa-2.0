...
<head>
    ...
    <title>Infectious Disease OSCE 5th Year | Students Assistant UA</title>
    ...
    <div class="wrapper">
        ...
        <main>
            <div class="landing" style="width: 100%">
                ...
                <object data="oski/oski-5/Infect Diseases Algorithm 2018.pdf#toolbar=0" type="application/pdf"
                    width="100%" height="500px" style="margin-top:2rem; margin-bottom:2rem; border: none;">
                    <iframe src="oski/oski-5/Infect Diseases Algorithm 2018.pdf#toolbar=0" width="100%" height="500px"
                        style="margin-top:2rem; margin-bottom:2rem; border: none;">
                        This browser does not support PDFs. Please download the PDF to view it:
                        <a href="oski/oski-5/Infect Diseases Algorithm 2018.pdf">Download PDF</a>
                    </iframe>
                </object>
