...
<head>
    ...
    <title>Propaedeutics Pediatrics OSCE 3rd Year | Students Assistant UA</title>
    ...
    <div class="wrapper">
        ...
        <main>
            <div class="landing" style="width: 100%">
                ...
                <h1>Propaedeutics Pediatrics OSCE 3rd Year</h1>
                ...
                <object data="oski/oski-3/Oski-propedevtic-pediatric-1.pdf#toolbar=0" type="application/pdf"
                    width="100%" height="500px" style="margin-top:2rem; margin-bottom:2rem; border: none;">
                    <iframe src="oski/oski-3/Oski-propedevtic-pediatric-1.pdf#toolbar=0" width="100%" height="500px"
                        style="margin-top:2rem; margin-bottom:2rem; border: none;">
                        This browser does not support PDFs. Please download the PDF to view it:
                        <a href="oski/oski-3/Oski-propedevtic-pediatric-1.pdf">Download PDF</a>
                    </iframe>
                </object>
