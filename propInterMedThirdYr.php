...
<head>
    ...
    <title>Propaedeutics Internal Medicine 3rd Year| Students Assistant UA</title>
    ...
    <div class="wrapper">
        ...
        <main>
            <div class="landing" style="width: 100%">
                ...
                <h1>Propaedeutics Internal Medicine 3rd Year</h1>
                ...
                <object data="oski/oski-3/#toolbar=0" type="application/pdf" width="100%" height="500px"
                    style="margin-top:2rem; margin-bottom:2rem; border: none;">
                    <iframe src="oski/oski-3/#toolbar=0" width="100%" height="500px"
                        style="margin-top:2rem; margin-bottom:2rem; border: none;">
                        This browser does not support PDFs. Please download the PDF to view it:
                        <a href="oski/oski-3/#">Download PDF</a>
                    </iframe>
                </object>
                <object data="oski/oski-3/#toolbar=0" type="application/pdf"
                    style="width: 100%; margin-top:2rem; margin-bottom:2rem;" height="500px">
                    <embed src="oski/oski-3/#toolbar=0" type="application/pdf" width="100%" height="500px"
