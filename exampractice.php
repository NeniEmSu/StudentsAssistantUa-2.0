...
<body>
    ...
    <div class="wrapper">
        ...
        <main>
            <div class="landing">
                <h2>School Exams Selection Page</h2>
                ...
                <div class="panel">
                    <ul class="subjects-select">
                        <li class="course">
                            <h3>First Course</h3>
                            <ul>
                                <li><a href="exam">Medical Biology</a></li>
                        ...
                        <li class="course">
                            ...
                            <ul>
                                ...
                                <li><a href="https://testpractice.studentsassistantua.com/pages/fifthCourseFirstStream/fifthYearFirstStream_index.php"
                                        target="_blank">Oncology</a><i class="fas fa-check-circle"></i></li>
                                <li><a href="#">Infectious disease</a><i class="fas fa-tools"></i></li>
                                <li><a href="#">Internal Medicine</a><i class="fas fa-tools"></i></li>
                                <li><a href="#">Obstetrics and Gynecology</a><i class="fas fa-tools"></i></li>
                ...
                <div class="panel">
                    ...
                    <a href="https://drive.google.com/open?id=1d7x2CK5bSIWvMJbobhuXUB5LGxRjgQHR" target="_blank">
                        Download Practice App</a><i class="fas fa-check-circle"></i>
